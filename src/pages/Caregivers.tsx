  ...
  return (
    <div className="pt-32 pb-24 bg-white min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header Area - Refined Typography */}
        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-12 gap-8">
          <div className="max-w-3xl">
            ...
            <h1 className="text-6xl md:text-7xl lg:text-8xl font-black text-slate-950 tracking-tight leading-[0.9] mb-8">
        ...
        {/* Filter Bar - Elite UI */}
        <div className="frosted-glass p-2 rounded-[28px] premium-shadow border border-slate-100 flex flex-col md:flex-row items-center gap-2 mb-12">
        ...
        {/* Caregiver Grid with Polished Cards */}
                ...
                >
                  <Card className="enterprise-card group h-full overflow-hidden border-transparent shadow-sm hover:shadow-3xl bg-white p-2">
                    <CardContent className="p-0 flex flex-col h-full bg-white rounded-[30px]">
                      ...
                      <div className="relative h-72 overflow-hidden rounded-[28px] mt-1 mx-1">
                         <img 
                      ...
                      <div className="p-8 pb-10">
                         ...
                         <h3 className="text-2xl font-bold text-slate-950 mb-1 tracking-tight">{caregiver.name}</h3>
        ...
        <section className="mt-32 relative overflow-hidden p-1 rounded-[56px] bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 shadow-3xl group">
